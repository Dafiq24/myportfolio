...
# Production is enabled by the deployment environment.
PRODUCTION = os.getenv("PRODUCTION", "False").lower() == "true"

# Keep the production key outside version control. The fallback is only used
# while developing locally, so a fresh clone can still run immediately.
